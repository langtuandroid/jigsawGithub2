...
namespace LitJson
{
    ...
    public class JsonReader
    {
		...
		public bool           ignore_missing_properties;
        #endregion
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="LitJson.JsonReader"/> ignores missing properties.
		/// Allows for weaker binding between a json object and a c# one.
		/// </summary>
		/// <value>
		/// <c>true</c> if should ignore missing properties; otherwise, <c>false</c>.
		/// </value>
		public bool IgnoreMissingProperties
		{
			get 
			{
				return ignore_missing_properties;
			}
			set
			{
        ...
        public bool Read ()
        {
            ...
            while (true) {
                ...
                try {
					...
					Debug.LogError("Invalid character in Json: " + (char)current_input);
